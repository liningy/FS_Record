...
public:
	...
	//constructor
	button(string _buttonName, int _originX, int _originY, int _bWidth, int _bHeight, bool _trigger,string _imgName_a, string _imgName_b, int _alternateOriginX = NULL, int _alternateOriginY = NULL);
	
	//functionality
	void drawFont(bool _buttonPressed, bool alternatePic = false);//alternate pic forces secondary pic to be used regardless of buttonPress state
